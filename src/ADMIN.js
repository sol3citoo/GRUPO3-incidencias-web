  ...
  return (
    <div className="vh-100 d-flex flex-column">
      <header className="bg-dark text-white p-3 shadow">
        <div className="container"><strong>Página Usuario Administrador</strong></div>
      </header>
      ...
      <main className="flex-grow-1 d-flex flex-column justify-content-center align-items-center px-4">
        ...
        <div className="d-flex flex-wrap justify-content-center gap-3">
          ...
          <button className="btn btn-secondary btn-lg rounded-pill px-4 shadow-sm">Gestión de usuarios/roles</button>
