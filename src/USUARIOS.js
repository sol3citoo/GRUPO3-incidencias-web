        ...
        <div className="row g-5">
          ...
          <div className="col-md-5 text-center px-lg-4">
            ...
            <form onSubmit={agregarUsuario} className="text-start">
              <input name="nombre" className="form-control mb-3 border-dark" placeholder="Nombre" onChange={manejarCambio} required />
              <input name="apellidos" className="form-control mb-3 border-dark" placeholder="Apellidos" onChange={manejarCambio} required />
              <input name="email" type="email" className="form-control mb-3 border-dark" placeholder="Email" onChange={manejarCambio} required />
              <input name="password" type="password" className="form-control mb-3 border-dark" placeholder="Contraseña" onChange={manejarCambio} required />
              ...
              <div className="d-flex justify-content-center gap-2">
                <button type="button" className="btn btn-secondary btn-lg rounded-pill px-4 fs-6" onClick={() => <Link to="/admin">Inicio</Link>}>
                  Inicio
                </button>
